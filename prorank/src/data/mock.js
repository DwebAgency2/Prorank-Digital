  ...
  services: [
    {
      ...
      description:
        "Comprehensive website analysis and customized SEO roadmap to identify opportunities and maximize your ranking potential.",
      icon: "Search",
      features: [
        "Technical SEO audit",
        "Competitor analysis",
    ...
    },
    {
      ...
      description:
        "Complete optimization of your website content, metadata, site speed, and mobile performance for better search rankings.",
      icon: "FileText",
      features: [
    ...
    },
    {
      ...
      description:
        "Strategic backlink building and local SEO citations to establish authority and improve your domain ranking.",
      icon: "Link",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete website redesign and restructuring focused on user experience, conversion optimization, and search performance.",
      icon: "Layout",
      features: [
        "UX/UI redesign",
    ...
    },
    {
      ...
      description:
        "Continuous monitoring, optimization, and detailed reporting to ensure sustained growth and ranking improvements.",
      icon: "TrendingUp",
      features: [
        "Monthly reporting",
